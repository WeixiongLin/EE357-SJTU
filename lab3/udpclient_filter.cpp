...
static void * pthread(void *arg){
    ...
    while(1){
        ...
        if(strcmp(addressBuffer, ip_addr) != 0){
            // cout << "addressBuffer " << addressBuffer << endl;
            cout << "<<<" << ip_addr << " says:";
            cout << buf << endl;
        }
        memset(buf,'\0',LEN);
...
int main(){
    ...
    while (ifAddrStruct!=NULL) 
    {
        ...
        { 
            ...
            inet_ntop(AF_INET, tmpAddrPtr, addressBuffer, INET_ADDRSTRLEN); // store client own IP in addressBuffer
            cout << "addressBuffer " << addressBuffer << endl;
        }
